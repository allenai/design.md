...
- Newsletter: distinct format with a lead story (compressed launch blog), a three-to-five-item news roundup, and optional event coverage. See `.agent/skills/ai2-comms-style-source/references/newsletter-format.md` for the rules.
